...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RestrictInfrastructure'
        db.create_table(u'restrict_restrictinfrastructure', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('is_hidden', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'restrict', ['RestrictInfrastructure'])
    ...
    def backwards(self, orm):
        # Deleting model 'RestrictInfrastructure'
        db.delete_table(u'restrict_restrictinfrastructure')
    ...
    models = {
        ...
        u'restrict.userdetail': {
            'Meta': {'object_name': 'UserDetail'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'token': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'user_detail'", 'unique': 'True', 'to': u"orm['auth.User']"})
        }
    }
