...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'users_userinfo', (
            ...
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='userinfo', unique=True, to=orm['auth.User'])),
    ...
    models = {
        ...
        u'users.userinfo': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'userinfo'", 'unique': 'True', 'to': u"orm['auth.User']"})
        }
    }
