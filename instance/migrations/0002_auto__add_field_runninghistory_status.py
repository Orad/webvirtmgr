...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RunningHistory.status'
        db.add_column(u'instance_runninghistory', 'status',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RunningHistory.status'
        db.delete_column(u'instance_runninghistory', 'status')
