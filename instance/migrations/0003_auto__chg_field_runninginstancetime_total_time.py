...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RunningInstanceTime.total_time'
        db.alter_column(u'instance_runninginstancetime', 'total_time', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=4))

    def backwards(self, orm):

        # Changing field 'RunningInstanceTime.total_time'
        db.alter_column(u'instance_runninginstancetime', 'total_time', self.gf('django.db.models.fields.TimeField')())
    ...
    models = {
        ...
        u'instance.runninginstancetime': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instance': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['instance.Instance']"}),
            'total_time': ('django.db.models.fields.DecimalField', [], {'max_digits': '20', 'decimal_places': '4'})
        },
